...
def gerar_sumario_executivo_pdf(dados: dict[str, Any]) -> bytes:
    ...
    # VTA-U2 (regra global): o Sumario apresenta UM unico VTA oficial. O
    # quadro de referencias auditaveis (posicao atual / ultima abertura /
    # contrato integralmente reajustado) saiu da apresentacao externa —
    # eram valores que podiam ser lidos como um segundo VTA. Os dados
    # seguem disponiveis em leitura['referencias_vta'] para auditoria.
