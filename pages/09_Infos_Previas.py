...
DATE_FIELDS = {
    "Data final vigente",
    "Data da proposta",
    "Data do pedido da empresa",
    "Data de efeitos financeiros anterior",
    "Data do aditivo",
}

MONEY_FIELDS = {
    "Valor do aditivo na assinatura",
    "Valor da garantia constituída",
}

PERCENT_FIELDS = {
    "Percentual já concedido",
    "Percentual de garantia previsto",
}
...
def _formatar_percentual_br(valor):
    ...
    if numero is None:
        return _texto(valor)
    # Interpreta o campo como percentual textual: 4,88 => 4,88%; 5 => 5,00%.
...
st.info(
    "Preencha a tabela abaixo. Ao normalizar, o sistema padroniza datas, moedas, percentuais e respostas Sim/Não sem criar um segundo formulário."
)
