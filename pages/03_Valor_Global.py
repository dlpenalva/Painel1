...
c4.metric("% de Reajuste", f"{percentual_reajuste:.2f}%") # Adicionado conforme solicitado
...
def gerar_planilha_fiscal():
    ...
    with pd.ExcelWriter(output, engine='xlsxwriter') as writer:
        ...
        # ABA RETROATIVO (36 MESES AUTOMÁTICOS)
...
# --- 2. DOWNLOAD (NOME RENOMEADO) ---
st.subheader("2. Download da Planilha de Coleta")
st.download_button(
    label="📥 Gerar Planilha para o Fiscal", # Nome original restaurado
