...
def _render_pendencia_documento(documento):
            ...
            with st.container(border=True):
                ...
                if chave == "planilha_executiva" and habilitado:
                    try:
                        ...
                        st.button("Arquivo indisponível", disabled=True, use_container_width=True)
                        st.caption(str(exc))
                    ...
                    if not valores.empty:
                        ...
                        _render_pendencia_documento(documento)
                    ...
                    st.page_link("pages/05_Garantia.py", label="Abrir documento", use_container_width=True)
                elif chave == "dou" and habilitado:
                    st.page_link("pages/13_DOU.py", label="Abrir documento", use_container_width=True)
                elif chave == "checklist_processual" and habilitado:
                    st.page_link("pages/07_Checklist_Processual.py", label="Abrir documento", use_container_width=True)
                else:
                    _render_pendencia_documento(documento)
