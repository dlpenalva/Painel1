# Relatório UX — Master 2.0: ciclos C2, histórico no XLS e carimbo de versão
...
Dados de ciclos anteriores, fatos históricos e instrumentos já formalizados não são mais coletados na interface. Esses registros pertencem exclusivamente ao XLS, onde podem ser preenchidos com a documentação disponível e auditados pelo fiscal/GCC.
...
- Ao iniciar em C2, C3 ou C4, a data-base é derivada pela linha anual iniciada no marco de C1, como no fluxo validado do 3.0.
- O formulário “Contexto do Contrato” e a marcação de ciclo já concedido foram removidos da web.
...
- O usuário não precisa declarar na web o que já ocorreu antes da análise atual.
...
- smoke público após publicação, incluindo carimbo de atualização e seleção C2.
